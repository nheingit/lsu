...
class ContextTypes(Generic[CCT, UD, CD, BD]):
  ...
  def __init__(
      self:
    "ContextTypes[CallbackContext[ExtBot[Any], ADict, ADict, ADict], ADict, ADict, ADict]",  # pylint: disable=line-too-long  # noqa: E501
  ):
    ...

  @overload
  def __init__(self: "ContextTypes[CCT, ADict, ADict, ADict]",
               context: Type[CCT]):
    ...
  ...
  def __init__(
    self:
    "ContextTypes[CallbackContext[ExtBot[Any], UD, ADict, ADict], UD, ADict, ADict]",
    user_data: Type[UD],
  ):
    ...
  ...
  def __init__(
    self:
    "ContextTypes[CallbackContext[ExtBot[Any], ADict, CD, ADict], ADict, CD, ADict]",
    chat_data: Type[CD],
  ):
    ...
  ...
  def __init__(
    self:
    "ContextTypes[CallbackContext[ExtBot[Any], ADict, ADict, BD], ADict, ADict, BD]",
    bot_data: Type[BD],
  ):
    ...

  @overload
  def __init__(self: "ContextTypes[CCT, UD, ADict, ADict]", context: Type[CCT],
               user_data: Type[UD]):
    ...

  @overload
  def __init__(self: "ContextTypes[CCT, ADict, CD, ADict]", context: Type[CCT],
               chat_data: Type[CD]):
    ...

  @overload
  def __init__(self: "ContextTypes[CCT, ADict, ADict, BD]", context: Type[CCT],
               bot_data: Type[BD]):
    ...
  ...
  def __init__(
    self:
    "ContextTypes[CallbackContext[ExtBot[Any], UD, CD, ADict], UD, CD, ADict]",
    user_data: Type[UD],
    chat_data: Type[CD],
  ):
    ...
  ...
  def __init__(
    self:
    "ContextTypes[CallbackContext[ExtBot[Any], UD, ADict, BD], UD, ADict, BD]",
    user_data: Type[UD],
    bot_data: Type[BD],
  ):
    ...
  ...
  def __init__(
    self:
    "ContextTypes[CallbackContext[ExtBot[Any], ADict, CD, BD], ADict, CD, BD]",
    chat_data: Type[CD],
    bot_data: Type[BD],
  ):
    ...
  ...
  def __init__(  # type: ignore[misc]
    self,
    context:
    "Type[CallbackContext[ExtBot[Any], ADict, ADict, ADict]]" = CallbackContext,
